...
正课上的错误：证明ℤ［δ］, δ^2+5=0 in ℤ中，2， 3， 1+δ， 1-δ都是不可约元：直接证明：若2可约，有(a+δb)|2, 且a,b为整数。则(a+δb)(a-δb)|2(a-δb)，所以a^2+5b^2是整数，且整除2(a-δb)，所以a^2+5b^2|2a, a^2+5b^2|2b. 若|a|>2, a^2>|2a|,第一个式子不可能。所以a<=2. 此时若b^2>=1，第一个式子依然不成立。所以b=0, a=1 or 2. 类似可证其它情况。
